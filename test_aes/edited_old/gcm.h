...
#include <stdint.h>
#include "aes.h"
#include "aes-128.h"                        // gcm_context includes aes_context
...
typedef struct {
    ...
    char base_ectr[16];    // first counter-mode cipher output for tag
    char y[16];            // the current cipher-input IV|Counter value
