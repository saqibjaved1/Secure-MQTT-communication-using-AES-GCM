                ...
                const uint keysize) // must be 128, 192 or 256
{
    ...
    // contiki library
    AES_128.set_key(key); 
    AES_128.encrypt(h);// This function takes in a pointer therefore dereferenced
    //********************************************************************************************** 	   
...
{
    //int ret;            // our error return if the AES encrypt fails (REMOVED)
